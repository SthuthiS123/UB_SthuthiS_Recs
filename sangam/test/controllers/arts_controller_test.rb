...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference("Art.count") do
      post arts_url, params: { art: { Subtitle: @art.Subtitle, Title: @art.Title, description: @art.description } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { Subtitle: @art.Subtitle, Title: @art.Title, description: @art.description } }
