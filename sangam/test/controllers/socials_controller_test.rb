...
class SocialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social" do
    assert_difference("Social.count") do
      post socials_url, params: { social: { Subtitle: @social.Subtitle, Title: @social.Title, description: @social.description } }
    end
  ...
  test "should update social" do
    patch social_url(@social), params: { social: { Subtitle: @social.Subtitle, Title: @social.Title, description: @social.description } }
